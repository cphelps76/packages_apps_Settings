...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        // demented - allows for calling the settings screen with stock or cm view
        boolean isdementedSecurity = false;
        Bundle args = getArguments();
        if (args != null) {
            isdementedSecurity = args.getBoolean("demented_security");
        }
        ...
        if (mIsPrimary && !isdementedSecurity) {
        ...
        } else if (!mLockPatternUtils.isLockScreenDisabled() && isdementedSecurity) {
            addPreferencesFromResource(R.xml.security_settings_slide_delay_demented);
        ...
        if (isdementedSecurity) {
            ...
            // Add the additional demented settings
            addPreferencesFromResource(R.xml.security_settings_demented);
        ...
        if (!isdementedSecurity) {
            ...
            addPreferencesFromResource(R.xml.security_settings_app_demented);
